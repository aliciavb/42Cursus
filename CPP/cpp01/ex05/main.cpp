// Do you know Harl? We all do, don’t we? In case you don’t, find below the kind
// of comments Harl makes. They are classified by levels:
...
// 
// You are going to automate Harl. It won’t be difficult since he always says the
// same things. You have to create a Harl class with the following private member
// functions:
// • void debug( void );
// • void info( void );
// • void warning( void );
...
// suggestion. Harl has to complain without using a forest of if/else if/else. He
// doesn’t think twice!
// 
